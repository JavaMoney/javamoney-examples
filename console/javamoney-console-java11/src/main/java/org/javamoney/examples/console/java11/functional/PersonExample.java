/*
 * JavaMoney Examples
 * Copyright 2014-2025, Werner Keil
 ...
 */
package org.javamoney.examples.console.java11.functional;
...
public class PersonExample {
	...
	public static void main(String[] args) {
		...
		final var roster = Person.createRoster();
		...
		p.getAge() >= 18 && p.getAge() <= 25, Person::printPerson);



		processPersonsWithFunction( roster, p -> p.getGender() ==
		Person.Sex.MALE && p.getAge() >= 18 && p.getAge() <= 25, Person::getEmailAddress, System.out::println);



		 processElements( roster, p -> p.getGender() == Person.Sex.MALE &&
		 p.getAge() >= 18 && p.getAge() <= 25, Person::getEmailAddress, System.out::println);
		 ...
		 .map(Person::getSalary) .forEach(System.out::println);
